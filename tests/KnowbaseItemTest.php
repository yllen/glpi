...
class KnowbaseItemTest extends DbTestCase {
   ...
   public function testGetTypeName() {
      ...
      $this->assertEquals($expected, KnowbaseItem::getTypeName(1));

      $expected = 'Knowledge base';
      $this->assertEquals($expected, KnowbaseItem::getTypeName(0));
      $this->assertEquals($expected, KnowbaseItem::getTypeName(2));
      $this->assertEquals($expected, KnowbaseItem::getTypeName(10));
   }

   public function testGetMenuShorcut() {
      $this->assertEquals('b', KnowbaseItem::getMenuShorcut());
   }

   public function testGetMenuName() {
      $expected = 'FAQ';
      $this->assertEquals($expected, KnowbaseItem::getMenuName());
   ...
   public function testCanCreate() {
      $this->assertFalse(KnowbaseItem::canCreate());

      $this->login();
      $this->assertTrue(KnowbaseItem::canCreate());
      Session::destroy();
   }
