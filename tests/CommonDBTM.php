...
class CommonDBTMTest extends PHPUnit_Framework_TestCase {
   ...
   public function testShowDates() {
      ...
      $result = $common->showDates();
      $this->assertEquals(
         "<tr class='tab_bg_1 footerRow'><th colspan=''></th><th colspan=''>Last updated on 2017-01-05 </th></tr>",
         $result
      );
      ...
      $result = $common->showDates();
      $this->assertEquals(
         "<tr class='tab_bg_1 footerRow'><th colspan=''>Created on 2017-01-01 </th><th colspan=''>Last updated on 2017-01-05 </th></tr>",
         $result
      );
      ...
      $this->assertEquals(
         "<tr class='tab_bg_1 footerRow'><th colspan='3'>Created on 2017-01-01 </th><th colspan='3'>Last updated on 2017-01-05 </th></tr>",
         $result
      );
      ...
      $result = $common->showDates($options);
      $this->assertEquals(
         "<tr class='tab_bg_1 footerRow'><th colspan='1'>Created on 2017-01-01 </th><th colspan='1'>Last updated on 2017-01-05 </th>" .
