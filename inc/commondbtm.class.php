   ...
   function showFormButtons($options=array()) {
      ...
      if ($params['withtemplate']
         ...
         if (($ID <= 0) || ($params['withtemplate'] == 2)) {
            $out .= Html::submit(_x('button', 'Add'), array('name' => 'add'));
         } else {
            //TRANS : means update / actualize
            $out .= Html::submit(_x('button', 'Save'), array('name' => 'update'));
         }
         ...
         if ($params['candel']) {
            ...
            if ($this->isDeleted()) {
               if ($this->can($ID, DELETE)) {
                  ...
                  $out .= Html::submit(_x('button', 'Restore'), array('name' => 'restore'));
               }
               ...
               if ($this->can($ID, PURGE)) {
                  ...
                  $out .= Html::submit(_x('button', 'Delete permanently'), array('name' => 'purge'));
                  $out .= "</span>";
               }
               ...
               if (!$this->maybeDeleted()
                  ...
                  if ($this->can($ID, PURGE)) {
                     $out .= Html::submit(_x('button', 'Delete permanently'),
                          ...
                          && $this->can($ID, DELETE)) {
                  $out .= Html::submit(_x('button', 'Put in dustbin'), array('name' => 'delete'));
               }
            }
